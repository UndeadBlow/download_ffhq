...
Scripts for download FFHQ dataset.

Originally taken here: https://github.com/NVlabs/ffhq-dataset, currently that script is not working with modern python 2.7 or python 3+ and has some other problems.
